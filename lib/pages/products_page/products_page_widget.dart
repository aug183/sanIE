  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProductsRecord>>(
      stream: queryProductsRecord(
        queryBuilder: (productsRecord) => productsRecord.orderBy('location'),
      ),
      builder: (context, snapshot) {
        ...
        List<ProductsRecord> productsPageProductsRecordList = snapshot.data!;
                              ...
                              child: Padding(
                                ...
                                child: Autocomplete<String>(
                                  ...
                                  optionsBuilder: (textEditingValue) {
                                    ...
                                    return productsPageProductsRecordList
                                        .map((e) => e.itemName)
                                        .toList()
                                        .where((option) {
                                        ...
                                        () async {
                                          safeSetState(() {
                                            _model.simpleSearchResults =
                                                TextSearch(
                                              productsPageProductsRecordList
                                                  .map(
                  ...
                  if (!FFAppState().searchActive)
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final noSearchView =
                              productsPageProductsRecordList.toList();
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            primary: false,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: noSearchView.length,
                            itemBuilder: (context, noSearchViewIndex) {
                              final noSearchViewItem =
                                  noSearchView[noSearchViewIndex];
                              return Visibility(
                                visible: functions.checkIfProductInCart(
                                        FFAppState().itemAppState.toList(),
                                        noSearchViewItem.barcode) ==
                                    false,
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 16.0, 8.0),
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          return ListView.builder(
                            ...
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: searchResultView.length,
                            itemBuilder: (context, searchResultViewIndex) {
                              final searchResultViewItem =
                                  searchResultView[searchResultViewIndex];
                              return Visibility(
                                visible: functions.checkIfProductInCart(
                                        FFAppState().itemAppState.toList(),
                                        searchResultViewItem.barcode) ==
                                    false,
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 16.0, 8.0),
