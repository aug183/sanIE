                                ...
                                children: [
                                    ...
                                    children: [
                                      ...
                                      Switch.adaptive(
                                        ...
                                        onChanged: (newValue) async {
                                          ...
                                          if (newValue!) {
                                            setState(() {
                                              _model.managerSwitchValue = false;
                                            });
                                          }
                                        },
                                        activeColor:
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Switch.adaptive(
                                        value: _model.managerSwitchValue ??=
                                            false,
                                        onChanged: (newValue) async {
                                          setState(() => _model
                                              .managerSwitchValue = newValue!);
                                          if (newValue!) {
                                            setState(() {
                                              _model.adminSwitchValue = false;
                                            });
                                          }
                                        },
                                        activeColor:
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                          ...
                                          : () async {
                                              if (_model.passwordController
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'Re-enter password does not match pasword',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                      ...
                                      options: FFButtonOptions(
                                        ...
                                        disabledTextColor: Color(0x4D14181B),
                                      ),
                                    ),
                                  ),
                                ],
